    ...
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-slate-300 mb-6">
          Get a weekly digest of the most upvoted AI use cases delivered to your inbox. Join{" "}
          <span className="font-semibold">{subscriberCount.toLocaleString()}+</span> other innovators.
        </p>
